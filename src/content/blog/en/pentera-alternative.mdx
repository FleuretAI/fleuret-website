...
faqs:
  ...
  - question: "What does Pentera cost vs Fleuret AI?"
    answer: "Pentera publishes an annual subscription benchmark around €46,000 per year for the full platform. Fleuret AI prices in tiers: Quick €500 per pentest, Standard €2,500 to €5,000, Continuous €25,000 to €35,000 per year with unlimited rescans, Design Partner cohort €4,900 flat. For external web app + API scope at continuous cadence, the cost gap is 30 to 60 percent in Fleuret's favour."
...
| Pricing transparency | Public tiers (€500 / €2.5-5k / €25-35k/yr) | Around €46,000 per year (public benchmarks) |
...
**Pricing tier gap.** Pentera's €46,000-per-year benchmark is roughly the same as Fleuret AI's Continuous tier price (€25,000 to €35,000 per year), but the platforms target different scope. A mid-market buyer with no internal-network problem who pays €46,000 per year for Pentera is solving the wrong problem. Same buyer at €25,000 per year on Fleuret Continuous covers the external surface where their risk actually lives.
...
**Quick-test or one-off engagement budget.** Fleuret AI's Quick tier at €500 per pentest is order-of-magnitude cheaper than any Pentera engagement. Right answer when the buying decision is "we need one external pentest before the auditor arrives".

...
- [NIS2 pentest for telecom](/compliance/nis2/telecom): the other dominant essential-entity sector and where supply-chain testing scope explodes.
- [NIS2 pentest for transport](/compliance/nis2/transport): rail and aviation, with the OT-IT boundary problem mirrored from energy.
- [NIS2 pentest for healthcare](/compliance/nis2/healthcare): hospitals and medical-device operators, where patient-safety overlaps with cybersecurity.

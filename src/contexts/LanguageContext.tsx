...
export const translations = {
  fr: {
    ...
    'problem.diptych.right': 'depuis le dernier audit',
    'problem.diptych.pentest': 'PENTEST',
    'problem.stat.value': '23 sur 25',

    // Redesign 2026-05-09 — HowItWorks timeline
    'process.eyebrow': 'PROCESS · 03 ÉTAPES',
    'process.deploy.duration': '4 MIN',
    'process.deploy.stat1': 'SURFACE EXTERNE',
    'process.deploy.stat2': '1 247 ACTIFS',
    'process.attack.duration': '2h 14m',
    'process.attack.stat1': 'CHAÎNES D\'EXPLOIT',
    'process.attack.stat2': '7 PoCs VALIDÉS',
    'process.exploits.duration': '11 MIN',
    'process.exploits.stat1': 'PDF AUDIT-GRADE',
    'process.exploits.stat2': 'ZÉRO FAUX-POS',
    'process.elapsed.label': 'ÉCOULÉ · PÉRIMÈTRE / ENGAGEMENT / RAPPORT',
    'process.elapsed.perimeter': 'PÉRIMÈTRE',
    'process.elapsed.engagement': 'ENGAGEMENT',
    'process.elapsed.report': 'RAPPORT',

    // Redesign 2026-05-09 — Comparison posters
    'comparison.eyebrow': 'Pas un cabinet. Pas un scanner. Une plateforme.',
    'comparison.band.rigor': 'Rigueur',
    'comparison.band.economics': 'Économie',
    'comparison.band.fit': 'Adéquation',
    'comparison.poster.firm': 'PAS UN CABINET',
    'comparison.poster.fleuret': 'LA PLATEFORME',
    'comparison.poster.scanner': 'PAS UN SCANNER',
  ...
  en: {
    ...
    'problem.diptych.left': '247 deploys YTD · 3.2/day',
    'problem.diptych.right': 'since last audit',
    'problem.diptych.pentest': 'PENTEST',
    'problem.stat.value': '23 of 25',
    ...
    'process.elapsed.perimeter': 'PERIMETER',
    'process.elapsed.engagement': 'ENGAGEMENT',
    'process.elapsed.report': 'REPORT',

    // Redesign 2026-05-09 — Comparison posters
    'comparison.eyebrow': 'Not a firm. Not a scanner. A platform.',
    'comparison.band.rigor': 'Rigor',
    'comparison.band.economics': 'Economics',
    'comparison.band.fit': 'Fit',
    'comparison.poster.firm': 'NOT A FIRM',
    'comparison.poster.fleuret': 'THE PLATFORM',

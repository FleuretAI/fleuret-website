...
- [NIS2 pentest for telecom](/compliance/nis2/telecom): the other dominant Annex I digital-infrastructure sector, where supply-chain testing scope explodes across MVNO/MNO/host-supplier chains.
- [NIS2 pentest for transport](/compliance/nis2/transport): rail, aviation, and maritime operators, with the OT-IT boundary problem mirrored from energy.

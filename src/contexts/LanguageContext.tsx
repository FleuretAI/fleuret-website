...
export const translations = {
  fr: {
    ...
    'pricing.poc.desc': 'Pentest complet par webapp. Paiement à l\'avance, livré en 72h.',
    'pricing.poc.f1': 'Pentest agentique complet',
    'pricing.poc.f2': 'Rapport PDF DORA / NIS2',
    'pricing.poc.f3': 'Findings reproductibles, zéro faux positif',
    'pricing.poc.f4': 'Livré en 72h',
    ...
    'pricing.starter.apps': '1 à 3 webapps',
    'pricing.starter.price': '10 000€',
    'pricing.starter.unit': '/ an',
    'pricing.starter.desc': '2 pentests par webapp par an. Accès plateforme, re-test inclus.',
    'pricing.starter.f1': '1 à 3 webapps couvertes',
    'pricing.starter.f2': '2 pentests / app / an',
    'pricing.starter.f3': 'Rapport PDF DORA / NIS2',
    'pricing.starter.f4': 'Re-test inclus',
    'pricing.starter.cta': 'Réserver une démo',

    'pricing.growth.name': 'Growth',
    'pricing.growth.apps': '4 à 10 webapps',
    'pricing.growth.price': '25 000€',
    'pricing.growth.unit': '/ an',
    'pricing.growth.desc': 'Re-scan hebdomadaire. Tickets Jira par finding. PDF audit-ready.',
    'pricing.growth.f1': '4 à 10 webapps couvertes',
    'pricing.growth.f2': 'Re-scan hebdomadaire automatique',
    'pricing.growth.f3': 'Tickets Jira avec lien de re-test',
    'pricing.growth.f4': 'PDF DORA / NIS2 audit-ready',
    'pricing.growth.f5': 'Export slide board pour revue trimestrielle',
    'pricing.growth.cta': 'Réserver une démo',

    'pricing.scale.name': 'Scale',
    'pricing.scale.apps': '10+ webapps',
    'pricing.scale.price': 'Sur mesure',
    'pricing.scale.unit': '',
    'pricing.scale.desc': 'Volume, CSM dédié, intégrations custom.',
    'pricing.scale.f1': 'Tout Growth +',
    'pricing.scale.f2': 'CSM dédié',
    'pricing.scale.f3': 'API + REST / GraphQL + infra externe',
    'pricing.scale.cta': 'Parler à un fondateur',
  ...
  en: {
    ...
    'pricing.poc.price': '€3,000',
    'pricing.poc.unit': '/ webapp',
    'pricing.poc.desc': 'Full pentest per webapp. Paid upfront, delivered in 72 hours.',
    'pricing.poc.f1': 'Full agentic pentest',
    'pricing.poc.f2': 'DORA / NIS2 PDF report',
    'pricing.poc.f3': 'Reproducible findings, zero false positives',
    'pricing.poc.f4': 'Delivered in 72 hours',
    ...
    'pricing.starter.name': 'Starter',
    'pricing.starter.apps': '1 to 3 webapps',
    'pricing.starter.price': '€10,000',
    'pricing.starter.unit': '/ year',
    'pricing.starter.desc': '2 pentests per webapp per year. Platform access, re-test included.',
    'pricing.starter.f1': '1 to 3 webapps covered',
    'pricing.starter.f2': '2 pentests / app / year',
    'pricing.starter.f3': 'DORA / NIS2 PDF report',
    'pricing.starter.f4': 'Re-test included',
    'pricing.starter.cta': 'Book a demo',

    'pricing.growth.name': 'Growth',
    'pricing.growth.apps': '4 to 10 webapps',
    'pricing.growth.price': '€25,000',
    'pricing.growth.unit': '/ year',
    'pricing.growth.desc': 'Weekly automated rescan. Jira tickets per finding. Audit-ready PDF.',
    'pricing.growth.f1': '4 to 10 webapps covered',
    'pricing.growth.f2': 'Weekly automated rescan',
    'pricing.growth.f3': 'Jira tickets with re-test link',
    'pricing.growth.f4': 'DORA / NIS2 audit-ready PDF',
    'pricing.growth.f5': 'Board-deck export for quarterly review',
    ...
    'pricing.scale.unit': '',
    'pricing.scale.desc': 'Volume pricing, dedicated CSM, custom integrations.',
    'pricing.scale.f1': 'Everything in Growth +',
    'pricing.scale.f2': 'Dedicated CSM',
    'pricing.scale.f3': 'REST / GraphQL APIs + external infra',
    'pricing.scale.cta': 'Talk to a founder',

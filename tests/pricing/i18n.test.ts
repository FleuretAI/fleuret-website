...
const REQUIRED_PRICING_KEYS = [
  ...
  "pricing.description",
  "pricing.pentest.name",
  "pricing.pentest.price",
  "pricing.pentest.unit",
  "pricing.pentest.depth",
  "pricing.pentest.desc",
  "pricing.pentest.f1",
  "pricing.pentest.f2",
  "pricing.pentest.f3",
  "pricing.pentest.cta",
  "pricing.advanced.name",
  "pricing.advanced.price",
  "pricing.advanced.unit",
  "pricing.advanced.depth",
  "pricing.advanced.desc",
  "pricing.advanced.f1",
  "pricing.advanced.f2",
  "pricing.advanced.f3",
  "pricing.advanced.cta",
  "pricing.continuous.name",
  "pricing.continuous.price",
  "pricing.continuous.unit",
  "pricing.continuous.depth",
  "pricing.continuous.desc",
  "pricing.continuous.f1",
  "pricing.continuous.f2",
  "pricing.continuous.f3",
  "pricing.continuous.f4",
  "pricing.continuous.f5",
  "pricing.continuous.cta",
...
describe("i18n — REGRESSION: orphan keys removed", () => {
  ...
  const DROPPED = [
    ...
    // Dropped in the XBOW-mirror 3-card rework: POC card, category tabs,
    // and the Starter/Growth/Scale subscription tiers.
    "pricing.poc.name",
    "pricing.poc.price",
    "pricing.poc.unit",
    "pricing.poc.desc",
    ...
    "pricing.tab.poc",
    "pricing.tab.continuous",
    "pricing.label.poc.sub",
    "pricing.label.continuous.sub",
    "pricing.continuous.title",
    "pricing.continuous.subtitle",
    "pricing.starter.name",
    "pricing.starter.apps",
    "pricing.starter.price",
    "pricing.starter.unit",

...
const translations = {
  fr: {
    ...
    'about.investors.subtitle': 'Soutenus par les meilleurs fonds européens en cybersécurité.',
  ...
  en: {
    ...
    'about.investors.subtitle': 'Backed by Europe\'s best cybersecurity investors.',

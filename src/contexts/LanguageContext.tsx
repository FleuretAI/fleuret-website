...
export const translations = {
  fr: {
    ...
    'footer.legal.subProcessors': 'Sous-processeurs',
    ...
    // Pricing — POC tier (entry SKU, project shape, one-time)
    'pricing.poc.name': 'POC',
    'pricing.poc.price': '3 000€',
    'pricing.poc.unit': '/ webapp',
    'pricing.poc.desc': 'Un pentest complet sur une webapp. Paiement à l\'avance, livré en 2 semaines.',
    'pricing.poc.f1': 'Pentest agentique complet (1 webapp)',
    'pricing.poc.f2': 'Rapport PDF DORA / NIS2',
    'pricing.poc.f3': 'Findings reproductibles, zéro faux positif',
    'pricing.poc.f4': 'Livré en 2 semaines',
    'pricing.poc.cta': 'Réserver une démo',
    'pricing.poc.upgradeCredit': 'Crédité sur l\'année 1 du tier Recurring si vous passez en continu sous 6 mois.',

    // Pricing — Recurring tier (strategic SKU, subscription, the moat)
    'pricing.recurring.name': 'Recurring',
    'pricing.recurring.price1yr': '30 000€',
    'pricing.recurring.price3yr': '27 000€',
    'pricing.recurring.unit': '/ an',
    'pricing.recurring.desc': 'Re-scan automatique chaque semaine. Tickets Jira par finding. PDF auditeur signé.',
    'pricing.recurring.f1': 'WebApps illimitées (équipe entière)',
    'pricing.recurring.f2': 'Re-scan hebdomadaire automatique',
    'pricing.recurring.f3': 'Tickets Jira avec lien de re-test',
    'pricing.recurring.f4': 'PDF DORA / NIS2 signé Ed25519',
    'pricing.recurring.f5': 'Export slide board pour revue trimestrielle',
    'pricing.recurring.f6': 'API + REST / GraphQL + infra externe inclus',
    'pricing.recurring.cta': 'Réserver une démo',
    'pricing.recurring.toggle.1yr': '1 an',
    'pricing.recurring.toggle.3yr': '3 ans',
    'pricing.recurring.toggle.savings': 'Économisez 10 % sur 3 ans',

    // Pricing — guarantee (applies to POC SKU only)
    'pricing.guarantee.title': '0 finding, 0 facture.',
    'pricing.guarantee.subtitle': 'Si Fleuret ne trouve rien d\'exploitable sur votre POC, vous ne payez rien.',
    'pricing.anchor': 'vs 25 000€+ pour un pentest de cabinet annuel',

    // Pricing — Design Partner cross-link banner (visible while DP_COHORT_VISIBLE)
    'pricing.dpBanner.title': 'Cohorte Design Partner ouverte jusqu\'au 1er juin',
    'pricing.dpBanner.subtitle': '3 pentests pour 4 900€ (vs 9 000€ au prix POC). 5 places.',
    'pricing.dpBanner.cta': 'Voir la cohorte',

    // Pricing — Partners cross-link banner (channel partner entry)
    'pricing.partnersBanner.title': 'Vous êtes une plateforme GRC ou un marketplace pentest ?',
    'pricing.partnersBanner.subtitle': 'Fleuret se vend en marque blanche. Marges canal claires.',
    'pricing.partnersBanner.cta': 'Devenir partenaire',

    // Partners page
    'partners.hero.title': 'Pentest agentique en marque blanche pour votre plateforme.',
    'partners.hero.subtitle': 'Plateforme GRC, marketplace pentest, ou conseil cyber : Fleuret se branche dans votre offre. Souverain EU, conforme DORA et NIS2, prêt à signer un DPA.',
    'partners.hero.cta': 'Parler à un fondateur',

    'partners.who.title': 'Pour qui ?',
    'partners.who.grc.title': 'Plateformes GRC',
    'partners.who.grc.body': 'Vanta, Sprinto, Drata, Bastion, Secureframe, Thoropass, Scytale et leurs équivalents EU. Vos clients ont besoin de pentest pour leur audit. Branchez Fleuret comme tile pentest dans votre marketplace.',
    'partners.who.marketplace.title': 'Marketplaces pentest',
    'partners.who.marketplace.body': 'Yogosha-style. Bug bounty + pentest structuré, même portefeuille client. Modèle transactionnel par engagement, marge claire à chaque pentest.',
    'partners.who.advisory.title': 'Conseil cyber et audit',
    'partners.who.advisory.body': 'Almond, Stoïk, Big4 EU. Sous-traitez la partie pentest sans monter une équipe offensive en interne. Rapports signés Ed25519, prêts pour le commissaire aux comptes.',

    'partners.model.title': 'Le modèle wholesale',
    'partners.model.grc.label': 'GRC SaaS',
    'partners.model.grc.value': '50% sur Recurring',
    'partners.model.grc.detail': '15 000 € / an wholesale sur le tier Recurring (prix de liste 30 000 €). Vous fixez le retail, vous gardez la marge. Revenu récurrent attaché à votre ARR.',
    'partners.model.marketplace.label': 'Marketplace',
    'partners.model.marketplace.value': '60% sur POC',
    'partners.model.marketplace.detail': '1 800 € wholesale par pentest POC (prix de liste 3 000 € / webapp). Forme transactionnelle par engagement, intégration directe à votre marketplace.',

    'partners.included.title': 'Ce que vos clients reçoivent',
    'partners.included.f1': 'Pentest agentique complet en 2 semaines (POC) ou re-scan hebdomadaire (Recurring)',
    'partners.included.f2': 'Rapport PDF signé Ed25519, audit DORA et NIS2 ready, vérifiable hors ligne',
    'partners.included.f3': 'Tickets Jira par finding avec lien de re-test, prêts pour leur sprint dev',
    'partners.included.f4': 'Export slide board pour leur revue trimestrielle de risque',
    'partners.included.f5': 'Hébergement Scaleway France, modèles open-weight, zéro fuite hors UE',
    'partners.included.f6': 'Marque blanche disponible : votre logo sur le rapport, votre marketplace tile',

    'partners.proof.title': 'Preuve de souveraineté',
    'partners.proof.body': 'Tous les sous-processeurs Fleuret sont listés publiquement, hébergement 100 % UE, données client jamais sorties d\'Europe. Conformité RGPD article 28 et DPA partenaires.',
    'partners.proof.cta': 'Voir la liste des sous-processeurs',

    'partners.cta.title': 'Démarrons.',
    'partners.cta.body': 'Une démo de 30 minutes avec un fondateur. Pas de scripts. On regarde vos cas d\'usage, on cale le wholesale, on signe le NDA si besoin.',
    'partners.cta.button': 'Réserver une démo',
    ...
    'designPartners.hero.title': 'Construisez le futur du',
    'designPartners.hero.highlight': 'pentest avec nous.',
    'designPartners.hero.offer': '{price} forfait · {pentests} pentests IA · {weeks} semaines · rapport Compliance ready',
    ...
    'designPartners.timeline.w1.desc': 'Atelier 90 min. SOW signé, scope aligné : webapp, API, infra externe.',
    'designPartners.timeline.w2.title': 'Reconnaissance',
    'designPartners.timeline.w2.desc': 'Agents IA cartographient l\'exposition. ASM filtré, priorisé.',
    'designPartners.timeline.w3.title': 'Pentest WebApp + API',
    'designPartners.timeline.w3.desc': 'Attaques authentifiées et non-auth. PoC reproductible par finding.',
    'designPartners.timeline.w4.title': 'Pentest Infra externe',
    'designPartners.timeline.w4.desc': 'Surface externe, sous-domaines, endpoints exposés.',
    'designPartners.timeline.w5.title': 'Rapport audit-ready',
    'designPartners.timeline.w5.desc': 'PDF avec mapping NIS2 / DORA, plan de remédiation, slides COMEX.',
    'designPartners.timeline.w6.title': 'Revue & roadmap',
    'designPartners.timeline.w6.desc': 'Retex 60 min. Vos retours entrent dans la roadmap Q3.',
    ...
    'designPartners.pricingBanner.title': 'Après la cohorte ? Voir le tarif standard.',
    'designPartners.pricingBanner.subtitle': 'POC à 3 000 € / webapp ou Recurring à 30 000 € / an. Crédit POC vers Recurring si vous passez en continu sous 6 mois.',
    'designPartners.pricingBanner.cta': 'Voir la tarification',
  ...
  en: {
    ...
    'footer.legal.subProcessors': 'Sub-processors',
    'footer.legal.mentions': 'Mentions légales',
    'footer.about': 'About',
    ...
    'pricing.poc.price': '€3,000',
    'pricing.poc.unit': '/ webapp',
    'pricing.poc.desc': 'A full pentest on one webapp. Paid upfront, delivered in 2 weeks.',
    'pricing.poc.f1': 'Full agentic pentest (1 webapp)',
    'pricing.poc.f2': 'DORA / NIS2 PDF report',
    'pricing.poc.f3': 'Reproducible findings, zero false positives',
    'pricing.poc.f4': 'Delivered in 2 weeks',
    'pricing.poc.cta': 'Book a demo',
    'pricing.poc.upgradeCredit': 'Credited toward year 1 of Recurring if you upgrade within 6 months.',

    // Pricing — Recurring tier (strategic SKU, subscription, the moat)
    'pricing.recurring.name': 'Recurring',
    'pricing.recurring.price1yr': '€30,000',
    'pricing.recurring.price3yr': '€27,000',
    'pricing.recurring.unit': '/ year',
    'pricing.recurring.desc': 'Weekly automated rescan. Jira tickets per finding. Auditor-signed PDF.',
    'pricing.recurring.f1': 'Unlimited webapps (full team)',
    'pricing.recurring.f2': 'Weekly automated rescan',
    'pricing.recurring.f3': 'Jira tickets with re-test link',
    'pricing.recurring.f4': 'Ed25519-signed DORA / NIS2 PDF',
    'pricing.recurring.f5': 'Board-deck export for quarterly review',
    'pricing.recurring.f6': 'REST / GraphQL APIs + external infra included',
    'pricing.recurring.cta': 'Book a demo',
    'pricing.recurring.toggle.1yr': '1 year',
    'pricing.recurring.toggle.3yr': '3 years',
    'pricing.recurring.toggle.savings': 'Save 10% over 3 years',

    // Pricing — guarantee (applies to POC SKU only)
    'pricing.guarantee.title': '0 findings, 0 invoice.',
    'pricing.guarantee.subtitle': 'If Fleuret finds nothing exploitable on your POC, you pay nothing.',
    'pricing.anchor': 'vs €25,000+ for a yearly consulting-firm pentest',

    // Pricing — Design Partner cross-link banner (visible while DP_COHORT_VISIBLE)
    'pricing.dpBanner.title': 'Design Partner cohort open until June 1',
    'pricing.dpBanner.subtitle': '3 pentests for €4,900 (vs €9,000 at POC list). 5 seats.',
    'pricing.dpBanner.cta': 'See the cohort',

    // Pricing — Partners cross-link banner (channel partner entry)
    'pricing.partnersBanner.title': 'Are you a GRC platform or a pentest marketplace?',
    'pricing.partnersBanner.subtitle': 'Fleuret resells under your brand. Clear channel margins.',
    'pricing.partnersBanner.cta': 'Become a partner',

    // Partners page
    'partners.hero.title': 'White-label agentic pentest for your platform.',
    'partners.hero.subtitle': 'GRC platform, pentest marketplace, or cyber consultancy: Fleuret plugs into your offering. Sovereign EU, DORA and NIS2 ready, DPA-signable.',
    'partners.hero.cta': 'Talk to a founder',

    'partners.who.title': 'Who is this for?',
    'partners.who.grc.title': 'GRC platforms',
    'partners.who.grc.body': 'Vanta, Sprinto, Drata, Bastion, Secureframe, Thoropass, Scytale and EU equivalents. Your customers need pentest for their audit. Plug Fleuret in as the pentest tile in your marketplace.',
    'partners.who.marketplace.title': 'Pentest marketplaces',
    'partners.who.marketplace.body': 'Yogosha-style. Bug bounty plus structured pentest, same customer book. Transactional per-engagement model, clear margin on every pentest.',
    'partners.who.advisory.title': 'Cyber advisory and audit',
    'partners.who.advisory.body': 'Almond, Stoïk, EU Big4. Outsource the pentest portion without building an in-house offensive team. Reports Ed25519-signed, auditor-ready.',

    'partners.model.title': 'The wholesale model',
    'partners.model.grc.label': 'SaaS GRC',
    'partners.model.grc.value': '50% on Recurring',
    'partners.model.grc.detail': '€15,000 / year wholesale on the Recurring tier (list price €30,000). You set retail, you keep the margin. Recurring revenue attached to your ARR.',
    'partners.model.marketplace.label': 'Marketplace',
    'partners.model.marketplace.value': '60% on POC',
    'partners.model.marketplace.detail': '€1,800 wholesale per POC pentest (list price €3,000 / webapp). Transactional per-engagement shape, direct marketplace integration.',

    'partners.included.title': 'What your customers get',
    'partners.included.f1': 'Full agentic pentest in 2 weeks (POC) or weekly automated rescan (Recurring)',
    'partners.included.f2': 'Ed25519-signed PDF report, DORA and NIS2 audit-ready, offline-verifiable',
    'partners.included.f3': 'Jira tickets per finding with re-test link, ready for their dev sprint',
    'partners.included.f4': 'Board-deck export for their quarterly risk review',
    'partners.included.f5': 'Scaleway France hosting, open-weight models, zero data leakage outside the EU',
    'partners.included.f6': 'White-label available: your logo on the report, your marketplace tile',

    'partners.proof.title': 'Sovereignty proof',
    'partners.proof.body': 'All Fleuret sub-processors are publicly listed, 100% EU hosting, customer data never leaves Europe. GDPR article 28 and partner DPA compliant.',
    'partners.proof.cta': 'See the sub-processor list',

    'partners.cta.title': 'Let us start.',
    'partners.cta.body': 'A 30-minute demo with a founder. No scripts. We look at your use cases, calibrate the wholesale, sign the NDA if needed.',
    'partners.cta.button': 'Book a demo',
    ...
    'designPartners.hero.title': 'Build the future of',
    'designPartners.hero.highlight': 'pentest with us.',
    'designPartners.hero.offer': '{price} flat · {pentests} AI pentests · {weeks} weeks · Compliance-ready report',
    ...
    'designPartners.timeline.w1.title': 'Scope & kickoff',
    'designPartners.timeline.w1.desc': '90-min workshop. SOW signed, scope aligned: webapp, API, external infra.',
    'designPartners.timeline.w2.title': 'Reconnaissance',
    'designPartners.timeline.w2.desc': 'AI agents map your exposure. Filtered, prioritized ASM.',
    'designPartners.timeline.w3.title': 'WebApp + API pentest',
    'designPartners.timeline.w3.desc': 'Authenticated + unauth attacks. Reproducible PoC per finding.',
    'designPartners.timeline.w4.title': 'External infra pentest',
    'designPartners.timeline.w4.desc': 'External surface, subdomains, exposed endpoints.',
    'designPartners.timeline.w5.title': 'Audit-ready report',
    'designPartners.timeline.w5.desc': 'PDF with NIS2 / DORA mapping, remediation plan, exec slides.',
    'designPartners.timeline.w6.title': 'Review & roadmap',
    'designPartners.timeline.w6.desc': '60-min retrospective. Your feedback shapes the Q3 roadmap.',
    ...
    'designPartners.pricingBanner.title': 'After the cohort? See the standard pricing.',
    'designPartners.pricingBanner.subtitle': 'POC at €3,000 / webapp or Recurring at €30,000 / year. POC credits toward Recurring if you upgrade within 6 months.',
    'designPartners.pricingBanner.cta': 'See pricing',

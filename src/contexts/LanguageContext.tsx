...
export const translations = {
  fr: {
    ...
    'pricing.description': 'Un pentest à la demande, ou une couverture continue quand vous êtes prêt.',
    'pricing.startingAt': 'À partir de',
    'pricing.cta': 'Réserver une démo',

    // Pricing — Pentest (standard, per-test entry)
    'pricing.pentest.name': 'Pentest',
    'pricing.pentest.price': '4 000€',
    'pricing.pentest.unit': '/ test',
    'pricing.pentest.depth': 'La profondeur d\'un pentest manuel de 2 semaines, livré en heures.',
    'pricing.pentest.desc': 'Pour une application au périmètre simple.',
    'pricing.pentest.f1': 'PoC reproductible, zéro faux positif',
    'pricing.pentest.f2': 'Rapport PDF DORA / NIS2',
    'pricing.pentest.f3': 'Livré en heures, pas en semaines',
    'pricing.pentest.cta': 'Démarrer',

    // Pricing — Advanced pentest (per-test, deep)
    'pricing.advanced.name': 'Pentest Advanced',
    'pricing.advanced.price': '8 000€',
    'pricing.advanced.unit': '/ test',
    'pricing.advanced.depth': 'La profondeur d\'un pentest manuel de 4 semaines, livré en heures.',
    'pricing.advanced.desc': 'Apps complexes : logique métier, authentification, gros périmètre.',
    'pricing.advanced.f1': 'Tout le Pentest, périmètre étendu',
    'pricing.advanced.f2': 'API REST / GraphQL + infra externe',
    'pricing.advanced.f3': 'Chaînes d\'exploitation multi-étapes',
    'pricing.advanced.cta': 'Démarrer',

    // Pricing — Continuous (recurring, the moat, highlighted)
    'pricing.continuous.name': 'Continu',
    'pricing.continuous.price': 'Sur devis',
    'pricing.continuous.unit': '',
    'pricing.continuous.depth': 'Re-scan automatique, surfaces illimitées.',
    'pricing.continuous.desc': 'Le pentest devient une habitude, pas un événement annuel.',
    'pricing.continuous.f1': 'Re-scan hebdomadaire automatique',
    'pricing.continuous.f2': 'Tickets Jira avec lien de re-test',
    'pricing.continuous.f3': 'PDF audit DORA / NIS2 signé',
    'pricing.continuous.f4': 'Export slide board pour la revue trimestrielle',
    'pricing.continuous.f5': 'CSM dédié',
    'pricing.continuous.cta': 'Parler à l\'équipe',

    // Pricing — guarantee + anchor
    'pricing.guarantee.title': '0 finding, 0 facture.',
    'pricing.guarantee.subtitle': 'Si Fleuret ne trouve rien d\'exploitable sur votre premier test, vous ne payez rien.',
    'pricing.anchor': '4 000€ contre 15 000€ à 30 000€ pour un cabinet. Votre premier test est crédité si vous passez en continu.',
    ...
    'partners.who.advisory.body': 'Almond, Stoïk, Big4 EU. Sous-traitez la partie pentest sans monter une équipe offensive en interne. Rapports audit-ready, prêts pour le commissaire aux comptes.',

    'partners.model.title': 'Le modèle wholesale',
    'partners.model.grc.label': 'GRC SaaS',
    'partners.model.grc.value': '50% sur tiers continus',
    'partners.model.grc.detail': 'Wholesale 50% sur Starter (5 000 €) et Growth (12 500 €). Vous fixez le retail, vous gardez la marge. Revenu récurrent attaché à votre ARR.',
    ...
    'partners.included.f1': 'Pentest agentique complet en 72h (POC) ou re-scan hebdomadaire (Recurring)',
    'partners.included.f2': 'Rapport PDF audit-ready DORA et NIS2, vérifiable hors ligne',
  ...
  en: {
    ...
    'pricing.description': 'A pentest on demand, or continuous coverage when you are ready.',
    ...
    'pricing.pentest.price': '€4,000',
    'pricing.pentest.unit': '/ test',
    'pricing.pentest.depth': 'The depth of a 2-week manual pentest, delivered in hours.',
    'pricing.pentest.desc': 'For an application with a simple scope.',
    'pricing.pentest.f1': 'Reproducible PoC, zero false positives',
    'pricing.pentest.f2': 'DORA / NIS2 PDF report',
    'pricing.pentest.f3': 'Delivered in hours, not weeks',
    'pricing.pentest.cta': 'Get started',

    // Pricing — Advanced pentest (per-test, deep)
    'pricing.advanced.name': 'Advanced Pentest',
    'pricing.advanced.price': '€8,000',
    'pricing.advanced.unit': '/ test',
    'pricing.advanced.depth': 'The depth of a 4-week manual pentest, delivered in hours.',
    'pricing.advanced.desc': 'Complex apps: business logic, authentication, large scope.',
    'pricing.advanced.f1': 'Everything in Pentest, extended scope',
    'pricing.advanced.f2': 'REST / GraphQL APIs + external infra',
    'pricing.advanced.f3': 'Multi-step exploitation chains',
    'pricing.advanced.cta': 'Get started',

    // Pricing — Continuous (recurring, the moat, highlighted)
    'pricing.continuous.name': 'Continuous',
    'pricing.continuous.price': 'Custom',
    'pricing.continuous.unit': '',
    'pricing.continuous.depth': 'Automated rescan, unlimited surfaces.',
    'pricing.continuous.desc': 'Pentest becomes a habit, not a once-a-year event.',
    'pricing.continuous.f1': 'Weekly automated rescan',
    'pricing.continuous.f2': 'Jira tickets with re-test link',
    'pricing.continuous.f3': 'Signed DORA / NIS2 audit PDF',
    'pricing.continuous.f4': 'Board-deck export for quarterly review',
    'pricing.continuous.f5': 'Dedicated CSM',
    'pricing.continuous.cta': 'Talk to us',

    // Pricing — guarantee + anchor
    'pricing.guarantee.title': '0 findings, 0 invoice.',
    'pricing.guarantee.subtitle': 'If Fleuret finds nothing exploitable on your first test, you pay nothing.',
    'pricing.anchor': '€4,000 against €15,000 to €30,000 for a consulting firm. Your first test is credited if you go continuous.',
    ...
    'partners.who.advisory.body': 'Almond, Stoïk, EU Big4. Outsource the pentest portion without building an in-house offensive team. Reports audit-ready for your auditor.',

    'partners.model.title': 'The wholesale model',
    'partners.model.grc.label': 'SaaS GRC',
    'partners.model.grc.value': '50% on continuous tiers',
    'partners.model.grc.detail': 'Wholesale 50% on Starter (€5,000) and Growth (€12,500). You set retail, you keep the margin. Recurring revenue attached to your ARR.',
    'partners.model.marketplace.label': 'Marketplace',
    ...
    'partners.included.f1': 'Full agentic pentest in 72h (POC) or weekly automated rescan (Recurring)',
    'partners.included.f2': 'PDF report, DORA and NIS2 audit-ready, offline-verifiable',
    ...
    // Careers
    'careers.hero.title': 'Build the orchestration layer',
    'careers.hero.highlight': 'that lasts when GPT-7 ships.',
    'careers.hero.subtitle': 'Foundation-model labs ship a new SOTA every quarter. We don\'t compete on the 2% of value that lives in the model. We build the 98% that lives in agentic orchestration: the system that turns "scan this app" into a full pentest report with chained exploits, audit-ready evidence, and a PDF a DORA-regulated CISO can hand to their auditor. That orchestration layer is Émile. It is the moat. It is what we hire for.',
    'careers.hero.cta': 'Apply via Yanis',
    'careers.hero.ctaSecondary': 'How Émile works ↓',
    'careers.hero.email': 'yanis@fleuret.ai',
    'careers.build.title': 'What you\'ll build',
    'careers.build.card1.title': 'Agentic pentest orchestrator (Émile)',
    'careers.build.card1.desc': 'Émile coordinates a roster of specialist agents on every webapp pentest. Your job: extend the agent roster, ship the supervisor\'s memory layer so it stops re-asking the same questions on long horizons, improve the termination oracle so long runs know when they\'re done.',
    'careers.build.card1.stack': 'Stack: Python, open-weight LLMs on EU sovereign infra, the Coverage Graph data structure, in-house fine-tune pipeline.',
    'careers.build.card2.title': 'Offensive ML benchmark and eval harness',
    'careers.build.card2.desc': 'The agent stack is only as good as how you measure it. We run benchmark targets (intentionally vulnerable apps with known findings) to grade every agent version. Your job: industrialize it. Production-grade eval harness, regression detection per release, anti-cheat. Your weekly question becomes "did this commit regress us against the ground-truth set."',
    'careers.build.card2.stack': 'Stack: Python, containerized benchmark targets, custom IaC, EU sovereign cloud, relational store for the finding ledger.',
    'careers.build.card3.title': 'Coverage Graph and termination oracle',
    'careers.build.card3.desc': 'The Coverage Graph is the data structure that tracks which endpoints, params, and auth contexts have been tested. Without it, agents loop forever and CISOs don\'t trust the result. Your job: make it the system of record for "is this app done." Includes graph merge across pentests, gap-detection heuristics, exhaustiveness scoring that converts cleanly to an audit PDF.',
    'careers.build.card3.stack': 'Stack: TypeScript and Python, graph data store, custom visualizer.',
    'careers.build.card4.title': 'Production infra at scale',
    'careers.build.card4.desc': 'Pentests have a human-in-loop today. The gate to scale is closing that loop while growing concurrent capacity as channel partners ramp. Your job (if infra is your wedge): GPU pool management, orchestration queue, observability that catches a stuck agent before the customer notices.',
    'careers.build.card4.stack': 'Stack: EU sovereign cloud, Kubernetes, IaC, full observability stack.',
    'careers.emile.title': 'This isn\'t a wrapper. Here\'s the architecture.',
    'careers.emile.p1': 'A pentest isn\'t a single LLM call. It\'s hundreds of decisions chained over hours: enumerate the attack surface, prioritize endpoints, choose an exploit class, craft a payload, observe the response, decide whether to escalate. We model each decision as an agent\'s tool-call, and we orchestrate the chain with a supervisor agent that holds the Coverage Graph (the ledger of what\'s been tested, what\'s been found, what\'s left).',
    'careers.emile.p2': 'Every time a new frontier model ships, our agents get smarter for free. When open-weight catches up to closed-source, we swap models with a config change. The model is the commodity layer. The orchestration plus Coverage Graph plus termination oracle plus audit-PDF generator is the moat. That\'s what we own. That\'s where the 98% of customer-perceived value lives.',
    'careers.emile.p3': 'We\'re not a foundation-model research lab. If you want to publish on RLHF or fight Anthropic on alignment, this is the wrong job. We\'re an applied AI engineering team building infrastructure that compounds with the model frontier instead of competing with it. The right candidate finds the orchestration problem more interesting than the model problem.',
    'careers.positions.title': 'Open positions',
    'careers.positions.subtitle': 'Paris, hybrid 2-3 days remote.',
    'careers.positions.role1.title': 'AI Engineer (orchestration)',
    'careers.positions.role1.desc': 'Extend the Émile agent roster. Build the supervisor\'s memory layer and the termination oracle.',
    'careers.positions.role1.background': 'Likely background: 3+ years applied ML, comfortable with agent loops (LangGraph or your own), Python deep, has shipped production systems on top of foundation models.',
    'careers.positions.role1.subject': 'AI Engineer',
    'careers.positions.role2.title': 'Senior Offensive Security Engineer',
    'careers.positions.role2.desc': 'Own the agent payload library and the human-in-loop review layer.',
    'careers.positions.role2.background': 'Likely background: 5+ years pentest or offensive ops, OSCP or equivalent (we don\'t gate on certs), comfortable writing the agent\'s logic, not just using it. PASSI helpful, not required.',
    'careers.positions.role2.subject': 'Offensive Sec Eng',
    'careers.positions.role3.title': 'Founding Engineer (open scope)',
    'careers.positions.role3.desc': 'Pick your wedge: infra, Coverage Graph, benchmark harness, or the agent stack itself. Highest-agency seat on the team.',
    'careers.positions.role3.background': 'Likely background: 5+ years shipping production systems end-to-end. You\'d join the founding team.',
    ...
    // Platform page (dedicated /platform route)
    'platformPage.hero.title': 'How Émile',
    'platformPage.hero.highlight': 'works.',
    'platformPage.hero.subtitle': 'Multi-agent orchestration. Proof-of-concept validation. Audit-ready output. The engine behind continuous, human-grade pentesting at machine speed.',
    'platformPage.hero.cta': 'Book a demo',
    'platformPage.hero.ctaSecondary': 'Read the technical brief',

    'platformPage.philosophy.title': 'Evidence,',
    'platformPage.philosophy.highlight': 'not alerts.',
    'platformPage.philosophy.body': 'Security tools flood teams with noise: more alerts, more triage, more wasted cycles. Fleuret operates on a different principle. AI agents explore attack paths creatively, but findings only surface when exploitability is confirmed through controlled validation. If a finding can\'t be proven with a PoC, it doesn\'t reach your report.',

    'platformPage.process.title': 'How Fleuret tests',
    'platformPage.process.highlight': 'like an attacker.',
    'platformPage.process.subtitle': 'Fleuret doesn\'t follow a checklist. Émile coordinates dozens of specialist agents, each focused on a specific attack vector. They probe, adapt, and report back. Every finding is validated before it reaches your team.',
    'platformPage.process.step1.title': 'Define scope and launch',
    'platformPage.process.step1.desc': 'Start a pentest in clicks or via API. Set targets, authentication context, and compliance framework. Émile takes it from there.',
    'platformPage.process.step2.title': 'Map the attack surface',
    'platformPage.process.step2.desc': 'Automated reconnaissance discovers every exposed endpoint, subdomain, and entry point. The Coverage Graph begins tracking what needs testing.',
    'platformPage.process.step3.title': 'Execute multi-agent attacks',
    'platformPage.process.step3.desc': 'Specialist agents run real attacks in parallel: auth bypass, injection chains, business logic flaws, privilege escalation. Each agent scoped to one technique, retired after its mission.',
    'platformPage.process.step4.title': 'Validate and report',
    'platformPage.process.step4.desc': 'Every finding confirmed through a controlled, non-destructive proof-of-concept. Result: audit-ready PDF with DORA and NIS2 mapping, zero false positives.',

    'platformPage.arch.title': 'Architecture built for',
    'platformPage.arch.highlight': 'depth and trust.',
    'platformPage.arch.subtitle': 'Émile is a coordinated system of specialist agents, deterministic validators, and compliance-native reporting. Designed for production environments at scale.',
    'platformPage.arch.emile.title': 'Émile (Orchestrator)',
    'platformPage.arch.emile.desc': 'The supervisor that maintains a global view of the engagement, tracks the Coverage Graph, and directs agents to untested surfaces. Applies deterministic logic to prioritize attack paths and decide when a pentest is complete.',
    'platformPage.arch.agents.title': 'Attack Agents',
    'platformPage.arch.agents.desc': 'Short-lived, focused agents that each target a specific attack vector: authentication, injection, IDOR, business logic. They operate in parallel and are retired after their mission to prevent accumulated bias.',
    'platformPage.arch.validation.title': 'Validation Engine',
    'platformPage.arch.validation.desc': 'Confirms whether a discovered issue is truly exploitable using controlled, production-safe challenges. Reduces false positives to zero by enforcing proof before any finding enters the report.',
    'platformPage.arch.coverage.title': 'Coverage Graph',
    'platformPage.arch.coverage.desc': 'Tracks which endpoints, parameters, and auth contexts have been tested. The system of record for "is this pentest complete." Converts directly to exhaustiveness scores in the audit PDF.',
    'platformPage.arch.reporter.title': 'Compliance Reporter',
    'platformPage.arch.reporter.desc': 'Generates audit-ready output mapped to DORA, NIS2, ISO 27001, and SOC 2. PDF with reproducible PoCs, business impact, prioritized remediation, and offline verification.',

    'platformPage.wedge.title': 'Why consultancies and scanners',
    'platformPage.wedge.highlight': 'fall short.',
    'platformPage.wedge.body': 'Traditional pentesting consultancies deliver depth, but at €25,000+ per engagement, 2-to-4-week timelines, and once-a-year frequency. DAST scanners are fast and cheap, but shallow: they check known patterns without creative exploration, generating noise your team triages manually.',
    'platformPage.wedge.point1.title': 'Consultancies',
    'platformPage.wedge.point1.desc': 'Deep findings, but slow (2-4 weeks), expensive (€25k+), and annual. Your attack surface changes daily. Their report is stale before you read it.',
    'platformPage.wedge.point2.title': 'Legacy scanners',
    'platformPage.wedge.point2.desc': 'Fast and cheap, but no exploit chains, no business logic testing, no audit-ready report. High false-positive rate burns your team\'s trust.',
    'platformPage.wedge.point3.title': 'Fleuret',
    'platformPage.wedge.point3.desc': 'Human-grade depth at machine speed. Exploit-validated findings, zero false positives, audit-ready PDF. On-demand, every release.',

    'platformPage.diff.title': 'Fleuret is built',
    'platformPage.diff.highlight': 'differently.',
    'platformPage.diff.subtitle': 'Three design decisions that separate Fleuret from every other tool claiming AI security testing.',
    'platformPage.diff.point1.title': 'Specialist agents, not one monolithic AI',
    'platformPage.diff.point1.desc': 'Dozens of focused agents, each starting fresh with a scoped objective. No accumulated bias. No context collapse. When one agent finishes, another picks up the next attack vector.',
    'platformPage.diff.point2.title': 'Proof, not probability',
    'platformPage.diff.point2.desc': 'Findings ship with the actual, reproducible exploit as evidence. If it can\'t be proven, it doesn\'t reach your report. Zero false positives is a design decision, not a target.',
    'platformPage.diff.point3.title': 'Sovereign EU, model-agnostic',
    'platformPage.diff.point3.desc': 'Scaleway France hosting. Open-weight models. Customer data never leaves Europe. Swap models when the frontier moves: the value is in the orchestration, not the model.',

    'platformPage.production.title': 'Built for',
    'platformPage.production.highlight': 'production environments.',
    'platformPage.production.subtitle': 'Fleuret runs against live systems. Three guarantees make that safe: nothing gets broken, everything is logged, every finding maps to a regulation your auditor recognizes.',
    'platformPage.production.point1.title': 'Non-destructive validation',
    'platformPage.production.point1.desc': 'Exploit validation uses controlled challenges that confirm exploitability without modifying data or disrupting systems. Your production stays untouched.',
    'platformPage.production.point2.title': 'Full observability',
    'platformPage.production.point2.desc': 'Every agent action is logged: who, what, when, from where. The audit trail ships with the PDF. Your compliance team can trace every finding to its source.',
    'platformPage.production.point3.title': 'DORA and NIS2 aligned',
    'platformPage.production.point3.desc': 'Report format maps directly to regulatory pentest requirements. Ed25519-signed PDF for offline verification. Board-deck export for quarterly risk reviews.',

    'platformPage.cta.title': 'See agentic pentesting',
    'platformPage.cta.highlight': 'in action.',
    'platformPage.cta.subtitle': 'Fleuret surfaces real, exploitable risk at machine speed. AI agents discover. Deterministic validation confirms. Your team remediates what matters.',
    'platformPage.cta.button': 'Book a demo',
    'platformPage.cta.ctaSecondary': 'Talk to engineering',

    'platformPage.back': 'Back to home',

...
faqs:
  - question: "Is Fleuret AI a direct Escape alternative?"
    answer: "Yes, when the scope extends beyond APIs. Escape is the strongest French agentic engine for API and GraphQL business-logic testing with $18M Series A from Balderton. Fleuret AI covers web app + REST/GraphQL API + external infrastructure with shipped DORA / NIS2 audit PDFs and Jira-native workflow by default."
  - question: "When should I pick Escape over Fleuret AI?"
    answer: "Pick Escape when APIs are 80%+ of the testing surface, the buying logic is engineering-led, framework-tailored remediation snippets (Node.js, GraphQL) matter, and CI/CD integration speed is the binding constraint."
  - question: "When should I pick Fleuret AI over Escape?"
    answer: "Pick Fleuret when the scope spans API + infrastructure + external network, procurement is auditor-driven (not engineering-led), shipped DORA Article 24 + NIS2 Annex I mappings are required, and signed audit PDF is the primary regulatory artefact."
  - question: "Do Fleuret and Escape compete head-to-head on APIs?"
    answer: "On API depth specifically, Escape leads on BOLA / IDOR / business-logic coverage. Fleuret's multi-agent engine covers APIs as one of several surfaces. Buyers running an API-only POC often pick Escape; buyers running a mixed-surface POC often pick Fleuret."
  - question: "Are both French and EU-sovereign?"
    answer: "Yes. Both are headquartered in Paris and EU-eligible under DORA / NIS2. Fleuret documents an open-weight LLM stack on Scaleway France. Escape discloses its security stack in product trust pages."
  - question: "Can I use both Escape and Fleuret together?"
    answer: "Yes. Some buyers run Escape on the API layer and Fleuret on the broader attack surface (web app, external infra, internal scope). The vendors are complementary when API depth + multi-surface breadth are both required."
---
...
**LLM stack and sovereignty.** Fleuret runs documented open-weight LLMs on Scaleway France. Escape's LLM stack is partially disclosed; ask for the equivalent specificity in the technical demo if [EU AI Act high-risk audit preparedness](/blog/sovereign-eu-ai-pentest-cloud-act-2026) is a procurement gate.
...
If your scope goes beyond APIs and you need audit-ready evidence, [book a demo](/demo).

## Related reading

- [DORA pentest compliance for banking](/compliance/dora/banking)
- [ISO 27001 pentest for SaaS companies](/compliance/iso27001/saas)
...
- [Bug bounty vs penetration testing vs DAST: what each one catches](/blog/bug-bounty-vs-pentest-vs-dast)
- [Annual pentests are broken: continuous testing for SaaS](/blog/annual-pentest-broken-saas-continuous)
